...
// in half, which would otherwise render broken formatting in the preview.
              ...
              <div className="mt-4 p-4 bg-linear-to-r from-gray-50 to-blue-50 rounded-lg border">
                ...
                <div className="text-gray-700">
                  {isExpanded ? (
                    ...
                    <div className="prose prose-sm max-w-none">
                      <ReactMarkdown>
                        {truncateSummary(doc.aiSummary, 200)}
                      </ReactMarkdown>
                    </div>
                  )}
                </div>
                ...
                {doc.aiKeywords.length > 0 && (
                  <div className="mt-4 pt-3 border-t">
                    ...
                    <div className="flex flex-wrap gap-2">
                      {doc.aiKeywords.slice(0, 8).map((keyword) => (
                        <Badge
                          key={keyword}
                          variant="secondary"
                          className="px-3 py-1"
          ...
          <div className="space-y-2">
            ...
            <Select
              ...
              onValueChange={(value: AnalysisType | null) => {
                if (value) onAnalysisTypeChange(value);
              }}
            >
